...
class YandexAccountService
{
    ...
    public function getList(array $req)
    {
        ...
        $field = 'am.id,am.account_name,am.code,am.shop_id,am.is_invalid,am.create_time,am.update_time,am.is_authorization,am.sync_delivery,am.download_order,am.download_listing,s.site_status,c.seller_id,c.customer_id,a.register_time,a.fulfill_time';
        //有数据就取出
    ...
    public function changeStatus($data)
    {
        ...
        try {
            ...
            $new_data = $updata;
            $this->yandexAccountModel->allowField(true)->save($updata, ['id' => $data['id']]) and self::addYandexLog(
                $operator,
     ...
     * @author lingjiawen
     */
    public static function addYandexLog(array $base_info = [], int $type = 0, array $new_data = [], $old_data = []): void
    {
        $insert_data = [];
        $remark = [];
