    ...
    public function test()
    {
        $vars = [
            [
                ...
                'site' => 'sg',
                'category_id' => 9218,
                'name' => 'La Vestmon retro wave point printed shoulder patchwork dress sexy a wo',
                'cron_time' => '2019-04-24 11:26:02',
                'description' => 'point printed shoulder patchwork1',
                'short_description' => 'point printed shoulder patchwork2',
                'product_attribute' => [
                    'brand' => 'rondaful1',
                    'model' => 'xxxxx',
                ],
...
//            [
//                'id' => 0,   //新增时
//                'vid' => 1000001, // 新增时 sku_id
//                'image_url' => '100/033/985cffb9b579ef16a2989c8870269ba0.jpg',
//            ]
//        ];
        $imag = [
            [
                'id' => 52006,   //新增时
                'vid' => 5588, // 新增时 sku_id
                'image_url' => '1010/033/985cffb9b579ef16a2989c8870269ba0.jpg',
            ]
        ];
        $desc = 'point printed shoulder patchwork';
        $shortDesc = 'point printed shoulder patchwork';
        $arr = json_encode($vars);
        print_r($arr);
        exit;
    }
    ...
    public function update($params)
    {
        ...
        try {
            ...
            if (in_array($product['status'], [0, 2])) {
                ...
                $log['old_data'] = '';
                $log['new_data'] = json_encode($params);
                ...
                (new UniqueQueuer(LazadaUpdateListingQueue::class))->push($logId, $cronTime);
            }
