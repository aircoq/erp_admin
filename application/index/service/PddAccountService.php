...
class PddAccountService
{
    ...
    public function changeStatus($data)
    {
        ...
        try {
            ...
            $new_data = $updata;
            $this->pddAccountModel->allowField(true)->save($updata, ['id' => $data['id']]) and self::addPddLog(
                $operator,
                ChannelAccountLog::UPDATE,
                $new_data,
                $old_data
     ...
     * @author lingjiawen
     */
    public static function addPddLog(array $base_info = [], int $type = 0, array $new_data = [], $old_data = []): void
    {
        $insert_data = [];
        $remark = [];
