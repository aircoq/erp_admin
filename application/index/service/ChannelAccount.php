    ...
    public static function getAccount($channelId, $accountId)
    {
        switch ($channelId) {
	        ...
	        case ChannelAccountConst::channel_CD:
		        $account = CdAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Lazada:
		        $account = LazadaAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Joom:
		        $account = JoomAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Pandao:
		        $account = PandaoAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Shopee:
		        $account = ShopeeAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Paytm:
		        $account = PaytmAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Walmart:
		        $account = WalmartAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Vova:
		        $account = VovaAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Newegg:
		        $account = NeweggAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Oberlo:
		        $account = OberloAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Shoppo:
		        $account = ShoppoAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Pdd:
		        $account = PddAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Yandex:
		        $account = YandexAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Paypal:
		        $account = PaypalAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Fummart:
		        $account = FummartAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Souq:
		        $account = SouqAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_PM:
		        $account = PmAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Noon:
		        $account = NoonAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Merchant_Distribution:
		        $account = MerchantDistributionAccount::get($accountId, 60);
		        break;
	        case ChannelAccountConst::channel_Daraz:
		        $account = DarazAccount::get($accountId, 60);
		        break;
	        default:
                $account = null;
        }
