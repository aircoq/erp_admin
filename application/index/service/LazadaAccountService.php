...
class LazadaAccountService
{
    ...
    {
        $old_data = $this->lazadaAccountModel->where(['id' => $id])->find();
        ...
        $update_data = [];
        $update_data['status'] = $data['status'] ?? 0;
        $update_data['update_id'] = $data['user_id'];
        ...
        try {
            ...
            $res = $this->lazadaAccountModel->allowField(true)->save($update_data, ['id' => $id]);
