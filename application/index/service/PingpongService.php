...
class PingpongService
{
    ...
    public function getPingpongList()
    {
        ...
        $field = 'a.id,a.channel_id,a.site_code,a.account_id,a.account_number,a.account_name,a.status,a.create_id,a.create_time,
        a.operator_id,server.name as ip_name,server.ip as ip_address';
