...
class DarazAccountService
{
    ...
    public function update($id,$data)
    {
        ...
        try {
            ...
            self::addDarazLog($operator, 1, $new_data, $old_data);
    ...
    public function authorization($data)
    {
       ...
       $new_data = $model->toArray();
        ...
        $operator['operator'] = $data['realname'];
        $operator['account_id'] = $model->id;
        $res and self::addDarazLog($operator, 1, $new_data, $old_data);
     ...
     * @author lingjiawen
     */
    public static function addDarazLog(array $base_info = [], int $type = 0, array $new_data = [], $old_data = []): void
    {
        $insert_data = [];
        $remark = [];
